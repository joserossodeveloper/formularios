...
<div class="submissions-page">
                                            ...
                                            <div class="btn-group" role="group">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-right showHideColumns"
                                                    ...
                                                    <li class="item">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" class="column" data-key="index" value="2">
                                                                <?= Yii::t('app', '#') ?>
                                                            </label>
                                                        </div>
                                                    </li>
                                                    <li class="item">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" class="column" data-key="number" value="3">
                                                    ...
                                                    <li class="item">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" class="column" data-key="id" value="4">
                                                    ...
                                                    <li class="item">
                                                        <div class="checkbox">
                                                            <label>
                                                                <input type="checkbox" class="column" data-key="status" value="5">
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-hover table-list">
                        ...
                        <tr>
                            ...
                            <th class="status" data-field-name="status">
                                <a href="#" class="field-name" data-field-name="status" data-toggle="tooltip" data-placement="top" title="<?= Yii::t('app', 'Double opt-in offers an extra confirmation step to verify each email address added to your contact database.') ?>"><?= Yii::t('app', 'DOI Status') ?></a>
                            </th>
    ...
    <script type="text/template" id="submissionTemplate">
        ...
        <div class="status view table-cell">{{= statusLabel }}</div>
        <?php foreach ($fields as $field) { ?>
                            ...
                            <?php if (Yii::$app->user->can("viewFormSubmissionFiles", ['model' => $formModel])): ?>
                                <?php if (count($fileFields) > 0): ?>
                                    ...
                                    <tr data-file="{{= file.id }}">
                                        ...
                                        <td><a target="_blank" href="{{= file.link }}" title="<?= Yii::t('app', 'Download File') ?>">{{= file.originalName }}</a> ({{= file.extension }}, {{= file.sizeWithUnit }}) <?php if (Yii::$app->user->can("deleteFormSubmissionFiles", ['model' => $formModel])): ?><a class="removeFile" data-id="{{= file.id }}"><span class="glyphicon glyphicon-remove"> </span></a><?php endif; ?></td>
                                    </tr>
                                    {{ }); }}
                                    {{ } }}
                                <?php endif; ?>
