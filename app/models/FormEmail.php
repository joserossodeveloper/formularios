...
class FormEmail extends ActiveRecord
{
    ...
    public function attributeLabels()
    {
        return [
            ...
            'field_to' => Yii::t('app', 'Recipient (Email field)'),
            'to' => Yii::t('app', 'Recipient (Email address)'),
            'from' => Yii::t('app', 'Reply To'),
            'from_name' => Yii::t('app', 'From Name'),
            'cc' => Yii::t('app', 'Carbon Copy (cc)'),
            'bcc' => Yii::t('app', 'Blind Carbon Copy (bcc)'),
            'subject' => Yii::t('app', 'Subject'),
            'type' => Yii::t('app', 'Message'),
            'message' => Yii::t('app', 'Custom Message'),
            'plain_text' => Yii::t('app', 'Only Plain Text'),
            'attach' => Yii::t('app', 'Attach Uploaded Files'),
            'receipt_copy' => Yii::t('app', 'Includes a Submission Copy'),
    ...
    public function getEmailViews()
    {
        ...
        if ($this->type == $this::TYPE_LINK) {
            ...
            if ($this->plain_text) {
                $content['html'] = 'message-html-as-text';
            }
        }
