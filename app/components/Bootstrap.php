    ...
    public function bootstrap($app)
    {
        ...
        $app->on(Application::EVENT_BEFORE_REQUEST, function () use ($app) {
            ...
            try {
                ...
                } elseif ($app->settings->get('mailerTransport', 'app', $defaultMailerTransport) === 'sendgrid') {

                    // Set SendGrid mail component as mailer
                    $app->set('mailer', [
                        'class' => 'app\components\sendgrid\Mailer',
                        'apiKey' => $app->settings->get('sendgrid.key'),
                    ]);
